...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (productDetail) {
    ...
    if (productId) {
      ...
      if (product) {
        // Update page title
        document.title = `${product.name} - ClearlyU`;
          ...
          <div class="product-details">
            ...
            <div class="button-container">
              <a href="${product.amazonLink}" target="_blank" rel="noopener noreferrer" class="button primary-button full-width">
                <i class="fas fa-shopping-cart" style="padding-right: 6px; padding-top: 1px;"></i>
                Buy on Amazon
              </a>
            
              <a href="${product.flipkartLink}" target="_blank" rel="noopener noreferrer" class="button primary-button full-width" style="background-color: black;">
                <i class="fas fa-shopping-cart" style="padding-right: 6px; padding-top: 1px;"></i>
                Buy on Flipkart
              </a>
            </div>
...
const track = document.querySelector('.carousel-track');
  ...
  let index = 0;
  let autoPlayInterval = setInterval(() => moveSlide(1), 2000);
  ...
  carousel.addEventListener('mouseleave', () => {
    autoPlayInterval = setInterval(() => moveSlide(1), 2000);
  });